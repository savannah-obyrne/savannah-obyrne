...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="projects/client-operations-platform/README.md">
        <img src="assets/covers/client-operations-platform.png" alt="Client Operations Platform" width="100%">
      </a>
      <h3>Client Operations Platform</h3>
      <p>A full-stack operations application connecting booking journeys, participant requirements, waivers, payment states, check-in, and reporting.</p>
      <p><a href="projects/client-operations-platform/README.md">View the case study</a></p>
    </td>
    <td width="50%" valign="top">
      <a href="projects/content-brand-systems/README.md">
        <img src="assets/covers/content-brand-systems.png" alt="Content and Brand Systems" width="100%">
      </a>
      <h3>Content &amp; Brand Systems</h3>
      <p>A local-first workflow connecting project purpose, research evidence, revision history, human approvals, and export prerequisites.</p>
      <p><a href="projects/content-brand-systems/README.md">View the case study</a></p>
    </td>
  </tr>
</table>
